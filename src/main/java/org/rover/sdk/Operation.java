...
public abstract class Operation {
   ...
   */
  public org.rover.sdk.xdr.Operation toXdr() {
    org.rover.sdk.xdr.Operation xdr = new org.rover.sdk.xdr.Operation();
  ...
  public String toXdrBase64() {
    try {
      org.rover.sdk.xdr.Operation operation = this.toXdr();
      ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
      XdrDataOutputStream xdrOutputStream = new XdrDataOutputStream(outputStream);
      org.rover.sdk.xdr.Operation.encode(xdrOutputStream, operation);
   ...
   */
  public static Operation fromXdr(org.rover.sdk.xdr.Operation xdr) {
    org.rover.sdk.xdr.Operation.OperationBody body = xdr.getBody();
    Operation operation;
   ...
   */
  abstract org.rover.sdk.xdr.Operation.OperationBody toOperationBody();
}
