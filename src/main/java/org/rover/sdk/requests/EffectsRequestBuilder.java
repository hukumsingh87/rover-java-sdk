...
import org.rover.sdk.responses.GsonSingleton;
...
public class EffectsRequestBuilder extends RequestBuilder {
   ...
   * @see <a href="https://www.rover.network/developers/orbit/reference/effects-for-account.html">Effects for Account</a>
   ...
   * @see <a href="https://www.rover.network/developers/orbit/reference/effects-for-ledger.html">Effects for Ledger</a>
   ...
   * @see <a href="https://www.rover.network/developers/orbit/reference/effects-for-transaction.html">Effect for Transaction</a>
   ...
   * @see <a href="https://www.rover.network/developers/orbit/reference/effects-for-operation.html">Effect for Operation</a>
   ...
   * @throws TooManyRequestsException when too many requests were sent to the Orbit server.
   * @throws IOException
   */
  ...
  /**
   * Allows to stream SSE events from orbit.
   * Certain endpoints in Orbit can be called in streaming mode using Server-Sent Events.
   * This mode will keep the connection to orbit open and orbit will continue to return
   * responses as ledgers close.
   * @see <a href="http://www.w3.org/TR/eventsource/" target="_blank">Server-Sent Events</a>
   * @see <a href="https://www.rover.network/developers/orbit/learn/responses.html" target="_blank">Response Format documentation</a>
