...
import org.rover.sdk.xdr.DecoratedSignature;
import org.rover.sdk.xdr.EnvelopeType;
import org.rover.sdk.xdr.SignatureHint;
import org.rover.sdk.xdr.XdrDataOutputStream;
...
/**
 * Represents <a href="https://www.rover.network/developers/guides/concepts/transactions.html" target="_blank">Transaction</a> in Rover network.
 */
public class Transaction {
  ...
  public void sign(byte[] preimage) {
    ...
    org.rover.sdk.xdr.Signature signature = new org.rover.sdk.xdr.Signature();
  ...
  public byte[] signatureBase() {
    ...
    try {
      ...
      org.rover.sdk.xdr.Transaction.encode(xdrOutputStream, this.toXdr());
  ...
  /**
   * Returns fee paid for transaction in mint (1 mint = 0.0000001 XLX).
   */
  public int getFee() {
    return mFee;
  }
   ...
   */
  public org.rover.sdk.xdr.Transaction toXdr() {
    // fee
    org.rover.sdk.xdr.Uint32 fee = new org.rover.sdk.xdr.Uint32();
    fee.setUint32(mFee);
    // sequenceNumber
    org.rover.sdk.xdr.Uint64 sequenceNumberUint = new org.rover.sdk.xdr.Uint64();
    sequenceNumberUint.setUint64(mSequenceNumber);
    org.rover.sdk.xdr.SequenceNumber sequenceNumber = new org.rover.sdk.xdr.SequenceNumber();
    sequenceNumber.setSequenceNumber(sequenceNumberUint);
    // sourceAccount
    org.rover.sdk.xdr.AccountID sourceAccount = new org.rover.sdk.xdr.AccountID();
    sourceAccount.setAccountID(mSourceAccount.getXdrPublicKey());
    // operations
    org.rover.sdk.xdr.Operation[] operations = new org.rover.sdk.xdr.Operation[mOperations.length];
    for (int i = 0; i < mOperations.length; i++) {
      operations[i] = mOperations[i].toXdr();
    }
    // ext
    org.rover.sdk.xdr.Transaction.TransactionExt ext = new org.rover.sdk.xdr.Transaction.TransactionExt();
    ext.setDiscriminant(0);

    org.rover.sdk.xdr.Transaction transaction = new org.rover.sdk.xdr.Transaction();
   ...
   */
  public org.rover.sdk.xdr.TransactionEnvelope toEnvelopeXdr() {
    ...
    org.rover.sdk.xdr.TransactionEnvelope xdr = new org.rover.sdk.xdr.TransactionEnvelope();
    org.rover.sdk.xdr.Transaction transaction = this.toXdr();
  ...
  public String toEnvelopeXdrBase64() {
    try {
      org.rover.sdk.xdr.TransactionEnvelope envelope = this.toEnvelopeXdr();
      ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
      XdrDataOutputStream xdrOutputStream = new XdrDataOutputStream(outputStream);
      org.rover.sdk.xdr.TransactionEnvelope.encode(xdrOutputStream, envelope);
  ...
  public static class Builder {
    ...
    /**
     * Adds a new <a href="https://www.rover.network/developers/guides/concepts/list-of-operations.html" target="_blank">operation</a> to this transaction.
     * @param operation
    ...
    /**
     * Adds a <a href="https://www.rover.network/developers/guides/concepts/transactions.html" target="_blank">memo</a> to this transaction.
     * @param memo
     * @return Builder object so you can chain methods.
     * @see Memo
     */
    ...
    /**
     * Adds a <a href="https://www.rover.network/developers/guides/concepts/transactions.html" target="_blank">time-bounds</a> to this transaction.
     * @param timeBounds
     * @return Builder object so you can chain methods.
     * @see TimeBounds
     */
