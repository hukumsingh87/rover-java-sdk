...
import org.rover.sdk.xdr.TransactionResult;
import org.rover.sdk.xdr.XdrDataInputStream;
 ...
 * @see Server#submitTransaction(org.rover.sdk.Transaction)
 */
public class SubmitTransactionResponse extends Response {
    ...
    public static class Extras {
         ...
         * Use <a href="http://rover.github.io/xdr-viewer/">xdr-viewer</a> to debug.
         */
        public String getEnvelopeXdr() {
            return envelopeXdr;
        }
         ...
         * @see <a href="https://github.com/laxmicoinofficial/go/blob/master/services/orbit/main.go" target="_blank">Possible values</a>
         */
