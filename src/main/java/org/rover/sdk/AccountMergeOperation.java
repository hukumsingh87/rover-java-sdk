...
import org.rover.sdk.xdr.Operation.OperationBody;
import org.rover.sdk.xdr.OperationType;

import static com.google.common.base.Preconditions.checkNotNull;

/**
 * Represents <a href="https://www.rover.network/developers/guides/concepts/list-of-operations.html#account-merge" target="_blank">AccountMerge</a> operation.
...
public class AccountMergeOperation extends Operation {
    ...
    /**
     * The account that receives the remaining XLX balance of the source account.
     */
    ...
    OperationBody toOperationBody() {
        OperationBody body = new org.rover.sdk.xdr.Operation.OperationBody();
    ...
    public static class Builder {
         ...
         * @param destination The account that receives the remaining XLX balance of the source account.
         */
