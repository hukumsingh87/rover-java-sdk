...
import org.rover.sdk.xdr.PathPaymentOp;

import static com.google.common.base.Preconditions.checkArgument;
import static com.google.common.base.Preconditions.checkNotNull;

/**
 * Represents <a href="https://www.rover.network/developers/guides/concepts/list-of-operations.html#path-payment" target="_blank">PathPayment</a> operation.
...
public class PathPaymentOperation extends Operation {
  ...
  /**
   * The assets (other than send asset and destination asset) involved in the offers the path takes. For example, if you can only find a path from USD to EUR through XLX and BTC, the path would be USD -&raquo; XLX -&raquo; BTC -&raquo; EUR and the path would contain XLX and BTC.
   */
  ...
  org.rover.sdk.xdr.Operation.OperationBody toOperationBody() {
    ...
    // path
    org.rover.sdk.xdr.Asset[] path = new org.rover.sdk.xdr.Asset[this.path.length];
  ...
  public static class Builder {
     ...
     * @param path The assets (other than send asset and destination asset) involved in the offers the path takes. For example, if you can only find a path from USD to EUR through XLX and BTC, the path would be USD -&raquo; XLX -&raquo; BTC -&raquo; EUR and the path field would contain XLX and BTC.
