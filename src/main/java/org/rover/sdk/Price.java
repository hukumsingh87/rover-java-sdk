...
import org.rover.sdk.xdr.Int32;
...
/**
 * Represents Price. Price in Rover is represented as a fraction.
 */
public class Price {
    @SerializedName("n")
    private final int n;
    ...
    /**
     * Create a new price. Price in Rover is represented as a fraction.
     * @param n numerator
     * @param d denominator
     */
     ...
     */
    public org.rover.sdk.xdr.Price toXdr() {
        org.rover.sdk.xdr.Price xdr = new org.rover.sdk.xdr.Price();
        Int32 n = new Int32();
        Int32 d = new Int32();
        n.setInt32(this.n);
        d.setInt32(this.d);
