...
/**
 * Network class is used to specify which Rover network you want to use.
...
public class Network {
    private final static String PUBLIC = "Rover Public Mainnet ; April 2018";
    private final static String TESTNET = "Rover Testnet ; April 2018";
