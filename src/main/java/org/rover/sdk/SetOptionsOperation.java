...
import org.rover.sdk.xdr.*;

import static com.google.common.base.Preconditions.checkNotNull;

/**
 * Represents <a href="https://www.rover.network/developers/guides/concepts/list-of-operations.html#set-options">SetOptions</a> operation.
 * @see <a href="https://www.rover.network/developers/guides/concepts/list-of-operations.html">List of Operations</a>
 */
public class SetOptionsOperation extends Operation {
  ...
  /**
   * Indicates which flags to clear. For details about the flags, please refer to the <a href="https://www.rover.network/developers/guides/concepts/accounts.html" target="_blank">accounts doc</a>.
  ...
  /**
   * Indicates which flags to set. For details about the flags, please refer to the <a href="https://www.rover.network/developers/guides/concepts/accounts.html" target="_blank">accounts doc</a>.
   * You can also use {@link AccountFlag} enum.
   */
  ...
  /**
   * A number from 0-255 representing the threshold this account sets on all operations it performs that have <a href="https://www.rover.network/developers/guides/concepts/multi-sig.html" target="_blank">a low threshold</a>.
   */
  ...
  /**
   * A number from 0-255 representing the threshold this account sets on all operations it performs that have <a href="https://www.rover.network/developers/guides/concepts/multi-sig.html" target="_blank">a medium threshold</a>.
   */
  ...
  /**
   * A number from 0-255 representing the threshold this account sets on all operations it performs that have <a href="https://www.rover.network/developers/guides/concepts/multi-sig.html" target="_blank">a high threshold</a>.
   */
  ...
  org.rover.sdk.xdr.Operation.OperationBody toOperationBody() {
    ...
    if (signer != null) {
      org.rover.sdk.xdr.Signer signer = new org.rover.sdk.xdr.Signer();
  ...
  public static class Builder {
     ...
     * @param clearFlags For details about the flags, please refer to the <a href="https://www.rover.network/developers/guides/concepts/accounts.html" target="_blank">accounts doc</a>.
     * @return Builder object so you can chain methods.
     */
     ...
     * @param setFlags For details about the flags, please refer to the <a href="https://www.rover.network/developers/guides/concepts/accounts.html" target="_blank">accounts doc</a>.
     * @return Builder object so you can chain methods.
     */
    ...
    /**
     * Sets the account's home domain address used in <a href="https://www.rover.network/developers/guides/concepts/federation.html" target="_blank">Federation</a>.
     ...
     * @param signer The signer key. Use {@link org.rover.sdk.Signer} helper to create this object.
