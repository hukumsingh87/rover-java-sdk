...
public class SubmitTransactionResponseTest extends TestCase {
  ...
  public void testDeserializeTransactionFailureResponse() {
    String json = "{\n" +
            ...
            "  \"status\": 400,\n" +
            "  \"detail\": \"The transaction failed when submitted to the rover network. The `extras.result_codes` field on this response contains further details.  Descriptions of each code can be found at: https://www.rover.network/developers/guides/concepts/list-of-operations.html\",\n" +
            "  \"instance\": \"orbit-testnet-001.prd.rover001.internal.rover-ops.com/4elYz2fHhC-528285\",\n" +
            "  \"extras\": {\n" +
  ...
  public void testDeserializeOperationFailureResponse() {
    String json = "{\n" +
            ...
            "  \"status\": 400,\n" +
            "  \"detail\": \"The transaction failed when submitted to the rover network. The `extras.result_codes` field on this response contains further details.  Descriptions of each code can be found at: https://www.rover.network/developers/guides/concepts/list-of-operations.html\",\n" +
            "  \"instance\": \"orbit-testnet-001.prd.rover001.internal.rover-ops.com/4elYz2fHhC-528366\",\n" +
            "  \"extras\": {\n" +
