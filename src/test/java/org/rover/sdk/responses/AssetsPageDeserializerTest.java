...
public class AssetsPageDeserializerTest extends TestCase {
    ...
    public void testDeserialize() {
        ...
        assertEquals(page.getLinks().getSelf().getHref(), "https://orbit.rover.network/assets?order=asc&limit=10&cursor=");
        assertEquals(page.getLinks().getNext().getHref(), "https://orbit.rover.network/assets?order=asc&limit=10&cursor=AsrtoDollar_GDJWXY5XUASXNL4ABCONR6T5MOXJ2S4HD6WDNAJDSDKQ4VS3TVUQJEDJ_credit_alphanum12");
        ...
        assertEquals(page.getRecords().get(0).getLinks().getToml().getHref(), "https://www.rover.network/.well-known/rover.toml");
    ...
    String json = "{\n" +
            "  \"_links\": {\n" +
            "    \"self\": {\n" +
            "      \"href\": \"https://orbit.rover.network/assets?order=asc\\u0026limit=10\\u0026cursor=\"\n" +
            "    },\n" +
            "    \"next\": {\n" +
            "      \"href\": \"https://orbit.rover.network/assets?order=asc\\u0026limit=10\\u0026cursor=AsrtoDollar_GDJWXY5XUASXNL4ABCONR6T5MOXJ2S4HD6WDNAJDSDKQ4VS3TVUQJEDJ_credit_alphanum12\"\n" +
            "    },\n" +
            "    \"prev\": {\n" +
            "      \"href\": \"https://orbit.rover.network/assets?order=desc\\u0026limit=10\\u0026cursor=6497847_GCGNWKCJ3KHRLPM3TM6N7D3W5YKDJFL6A2YCXFXNMRTZ4Q66MEMZ6FI2_credit_alphanum12\"\n" +
            "    }\n" +
            "  },\n" +
            "  \"_embedded\": {\n" +
            "    \"records\": [\n" +
            ...
            "        \"_links\": {\n" +
            "          \"toml\": {\n" +
            "            \"href\": \"https://myrover.tools/.well-known/rover.toml\"\n" +
            "          }\n" +
            "        },\n" +
            "        \"asset_type\": \"credit_alphanum4\",\n" +
            "        \"asset_code\": \"ASD\",\n" +
