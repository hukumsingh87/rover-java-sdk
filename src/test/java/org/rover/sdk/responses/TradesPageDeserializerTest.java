...
public class TradesPageDeserializerTest extends TestCase {
    ...
    public void testDeserialize() {
        ...
        assertEquals(tradesPage.getLinks().getNext().getHref(), "https://orbit.rover.network/trades?order=asc&limit=10&cursor=3748308153536513-0");
        assertEquals(tradesPage.getLinks().getPrev().getHref(), "https://orbit.rover.network/trades?order=desc&limit=10&cursor=3697472920621057-0");
        assertEquals(tradesPage.getLinks().getSelf().getHref(), "https://orbit.rover.network/trades?order=asc&limit=10&cursor=");
    ...
    String json = "{\n" +
            "  \"_links\": {\n" +
            "    \"self\": {\n" +
            "      \"href\": \"https://orbit.rover.network/trades?order=asc\\u0026limit=10\\u0026cursor=\"\n" +
            "    },\n" +
            "    \"next\": {\n" +
            "      \"href\": \"https://orbit.rover.network/trades?order=asc\\u0026limit=10\\u0026cursor=3748308153536513-0\"\n" +
            "    },\n" +
            "    \"prev\": {\n" +
            "      \"href\": \"https://orbit.rover.network/trades?order=desc\\u0026limit=10\\u0026cursor=3697472920621057-0\"\n" +
            "    }\n" +
            "  },\n" +
            "  \"_embedded\": {\n" +
            "    \"records\": [\n" +
            ...
            "          },\n" +
            "          \"base\": {\n" +
            "            \"href\": \"https://orbit.rover.network/accounts/GAVH5JM5OKXGMQDS7YPRJ4MQCPXJUGH26LYQPQJ4SOMOJ4SXY472ZM7G\"\n" +
            "          },\n" +
            "          \"counter\": {\n" +
            "            \"href\": \"https://orbit.rover.network/accounts/GBB4JST32UWKOLGYYSCEYBHBCOFL2TGBHDVOMZP462ET4ZRD4ULA7S2L\"\n" +
            "          },\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://orbit.rover.network/operations/3697472920621057\"\n" +
            "          }\n" +
            "        },\n" +
            ...
            "          },\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://orbit.rover.network/operations/3712329212497921\"\n" +
            "          }\n" +
            "        },\n" +
            ...
            "          },\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://orbit.rover.network/operations/3716237632737281\"\n" +
            "          }\n" +
            "        },\n" +
            ...
            "          },\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://orbit.rover.network/operations/3716302057246721\"\n" +
            "          }\n" +
            "        },\n" +
            ...
            "          },\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://orbit.rover.network/operations/3725961438695425\"\n" +
            "          }\n" +
            "        },\n" +
            ...
            "          },\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://orbit.rover.network/operations/3748080520269825\"\n" +
            "          }\n" +
            "        },\n" +
            ...
            "          },\n" +
            "          \"operation\": {\n" +
            "            \"href\": \"https://orbit.rover.network/operations/3748308153536513\"\n" +
            "          }\n" +
            "        },\n" +
