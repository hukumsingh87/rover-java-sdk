...
public class OperationDeserializerTest extends TestCase {
  ...
  public void testDeserializeNonNativePaymentOperation() {
    String json = "{\n" +
            "        \"_links\": {\n" +
            "          \"self\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/operations/3603043769651201\"\n" +
            "          },\n" +
            "          \"transaction\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/transactions/b59dee0f85bc7efdefa1a6eec7a0b6f602d567cca6e7f587056d41d42ca48879\"\n" +
            "          },\n" +
            "          \"effects\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/operations/3603043769651201/effects\"\n" +
            "          },\n" +
            "          \"succeeds\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/effects?order=desc\\u0026cursor=3603043769651201\"\n" +
            "          },\n" +
            "          \"precedes\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/effects?order=asc\\u0026cursor=3603043769651201\"\n" +
            "          }\n" +
            "        },\n" +
            "        \"id\": \"3603043769651201\",\n" +
  ...
  public void testDeserializeAllowTrustOperation() {
    String json = "{\n" +
            "        \"_links\": {\n" +
            "          \"self\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/operations/3602979345141761\"\n" +
            "          },\n" +
            "          \"transaction\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/transactions/1f265c075e8559ee4c21a32ae53337658e52d7504841adad4144c37143ea01a2\"\n" +
            "          },\n" +
            "          \"effects\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/operations/3602979345141761/effects\"\n" +
            "          },\n" +
            "          \"succeeds\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/effects?order=desc\\u0026cursor=3602979345141761\"\n" +
            "          },\n" +
            "          \"precedes\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/effects?order=asc\\u0026cursor=3602979345141761\"\n" +
            "          }\n" +
            "        },\n" +
            "        \"id\": \"3602979345141761\",\n" +
  ...
  public void testDeserializeChangeTrustOperation() {
    String json = "{\n" +
            "        \"_links\": {\n" +
            "          \"self\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/operations/3602970755207169\"\n" +
            "          },\n" +
            "          \"transaction\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/transactions/8d409a788543895843d269c3f97a2d6a2ebca6e9f8f9a7ae593457b5c0ba6644\"\n" +
            "          },\n" +
            "          \"effects\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/operations/3602970755207169/effects\"\n" +
            "          },\n" +
            "          \"succeeds\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/effects?order=desc\\u0026cursor=3602970755207169\"\n" +
            "          },\n" +
            "          \"precedes\": {\n" +
            "            \"href\": \"//orbit-testnet.rover.network/effects?order=asc\\u0026cursor=3602970755207169\"\n" +
            "          }\n" +
            "        },\n" +
            "        \"id\": \"3602970755207169\",\n" +
  ...
  public void testDeserializeSetOptionsOperation() {
    String json = "{\n" +
            "        \"_links\": {\n" +
            "          \"self\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/operations/1253868457431041\"\n" +
            "          },\n" +
            "          \"transaction\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/transactions/cc392abf8a4e649f16eeba4f40c43a8d50001b14a98ccfc639783125950e99d8\"\n" +
            "          },\n" +
            "          \"effects\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/operations/1253868457431041/effects\"\n" +
            "          },\n" +
            "          \"succeeds\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/effects?order=desc\\u0026cursor=1253868457431041\"\n" +
            "          },\n" +
            "          \"precedes\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/effects?order=asc\\u0026cursor=1253868457431041\"\n" +
            "          }\n" +
            "        },\n" +
            "        \"id\": \"1253868457431041\",\n" +
    ...
    assertEquals(operation.getHomeDomain(), "rover.network");
  ...
  public void testDeserializeAccountMergeOperation() {
    String json = "{\n" +
            "        \"_links\": {\n" +
            "          \"self\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/operations/3424497684189185\"\n" +
            "          },\n" +
            "          \"transaction\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/transactions/68f4d37780e2a85f5698b73977126a595dff99aed852f14a7eb39221ce1f96d5\"\n" +
            "          },\n" +
            "          \"effects\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/operations/3424497684189185/effects\"\n" +
            "          },\n" +
            "          \"succeeds\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/effects?order=desc\\u0026cursor=3424497684189185\"\n" +
            "          },\n" +
            "          \"precedes\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/effects?order=asc\\u0026cursor=3424497684189185\"\n" +
            "          }\n" +
            "        },\n" +
            "        \"id\": \"3424497684189185\",\n" +
  ...
  public void testDeserializeManageOfferOperation() {
    String json = "{\n" +
            "        \"_links\": {\n" +
            "          \"self\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/operations/3320426331639809\"\n" +
            "          },\n" +
            "          \"transaction\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/transactions/1f8fc03b26110e917d124381645d7dcf85927f17e46d8390d254a0bd99cfb0ad\"\n" +
            "          },\n" +
            "          \"effects\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/operations/3320426331639809/effects\"\n" +
            "          },\n" +
            "          \"succeeds\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/effects?order=desc\\u0026cursor=3320426331639809\"\n" +
            "          },\n" +
            "          \"precedes\": {\n" +
            "            \"href\": \"https://orbit-testnet.rover.network/effects?order=asc\\u0026cursor=3320426331639809\"\n" +
            "          }\n" +
            "        },\n" +
            "        \"id\": \"3320426331639809\",\n" +
  ...
  public void testDeserializeManageDataOperation() {
    String json = "{\n" +
            "  \"_links\": {\n" +
            "    \"self\": {\n" +
            "      \"href\": \"https://orbit-testnet.rover.network/operations/14336188517191688\"\n" +
            "    },\n" +
            "    \"transaction\": {\n" +
            "      \"href\": \"https://orbit-testnet.rover.network/transactions/ad99999615f653528e67d8c8783e14044519c3e5233b73633aa88050c5856103\"\n" +
            "    },\n" +
            "    \"effects\": {\n" +
            "      \"href\": \"https://orbit-testnet.rover.network/operations/14336188517191688/effects\"\n" +
            "    },\n" +
            "    \"succeeds\": {\n" +
            "      \"href\": \"https://orbit-testnet.rover.network/effects?order=desc\\u0026cursor=14336188517191688\"\n" +
            "    },\n" +
            "    \"precedes\": {\n" +
            "      \"href\": \"https://orbit-testnet.rover.network/effects?order=asc\\u0026cursor=14336188517191688\"\n" +
            "    }\n" +
            "  },\n" +
