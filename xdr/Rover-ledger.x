...
/* RoverValue is the value used by RCA to reach consensus on a given ledger
*/
struct RoverValue
{
...
struct LedgerHeader
{
    ...
    RoverValue scpValue;   // what consensus agreed to
...
/* Ledger upgrades
note that the `upgrades` field from RoverValue is normalized such that
